...
export default function Inspector({ placeConfig, enableActorsFeature }: Props) {
  ...
  if (selectedType === 'place') {
    ...
    return (
      <div className="w-72 bg-white border-l border-gray-200 p-4 overflow-y-auto">
        ...
        <PlaceInspector place={place} placeConfig={placeConfig} />
      </div>
    );
  }
  ...
  if (selectedType === 'transition') {
    ...
    return (
      <div className="w-72 bg-white border-l border-gray-200 p-4 overflow-y-auto">
        ...
        <TransitionInspector transition={transition} enableActorsFeature={enableActorsFeature} />
      </div>
    );
  }
